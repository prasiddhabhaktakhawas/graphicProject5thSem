...
public:
    ...
    renderer(string objName, DWORD screenWidth, DWORD screenHeight, int xOffset, int yOffset)
    {
        ...
        meshObj.LoadFromObjectFile(objName);
        // meshObj.tris = {
    ...
    void mainLoop()
    {
        ...
        for (auto &triToRaster : vecTrianglesToRaster)
        {
            ...
            for (auto &t : listTriangles)
            {
                ...
                TexturedTriangle(t.p[0].x, t.p[0].y,
					t.p[1].x, t.p[1].y,
					t.p[2].x, t.p[2].y, t.col);
            }
        }
...
private:
    ...
    int Triangle_ClipAgainstPlane(vec3d plane_p, vec3d plane_n, triangle &in_tri, triangle &out_tri1, triangle &out_tri2)
    {
        ...
        else
        {
            ...
            // outside_tex[nInsideTexCount++] = &in_tri.t[0];
        }
        if (d1 >= 0)
        {
        ...
        else
        {
            ...
            // outside_tex[nInsideTexCount++] = &in_tri.t[1];
        }
        if (d2 >= 0)
        {
...
int main()
{
    ...
    renderer car("cyber.obj", screenWidth, screenHeight, -3, -3);
